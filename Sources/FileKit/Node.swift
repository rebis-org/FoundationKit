...
extension Node {
    ...
    public func path(relativeTo directory: Directory) -> String {
        path.relative(to: directory.path)
    }

    @discardableResult
    public func rename(to newName: String, keepExtension: Bool = true) throws -> Node {
    ...
    @discardableResult
    public func move(to directory: Directory) throws -> Node {
    ...
    @discardableResult
    public func copy(to directory: Directory) throws -> Node {
        let newPath = directory.path / name
