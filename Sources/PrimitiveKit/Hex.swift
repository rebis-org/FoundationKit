...
public enum Hex: Sendable {
    public static func encode(_ bytes: some Sequence<UInt8>, truncatedTo prefixLength: Int? = nil)
        -> String {
        ...
        // why: bytes are self-constructed nibble ASCII, valid UTF-8 by construction
    ...
    public static func encode(_ value: UInt64, truncatedTo prefixLength: Int? = nil) -> String {
        encode(
            (0 ..< 8).map { UInt8(truncatingIfNeeded: value >> (56 - $0 * 8)) }, truncatedTo: prefixLength)
    }
}
